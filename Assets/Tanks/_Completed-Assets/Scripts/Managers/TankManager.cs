...
namespace Complete
{
    ...
    public class TankManager
    {
        ...
        public void SetupAIFromGameManager(bool aiFromGameManager)
        {
            m_BasicAI.SetupAI(aiFromGameManager);
        }
